...
(다음 마일스톤은 **v0.5 — Pipeline 패키지 + PostgreSQL + 비동기 큐 + 검수 큐
+ default Haiku 전환** (minor bump). 자산화 우선 경로 (worklog/014 § 5-5) 가
v0.4.5 로 완료됨 — 5포맷 (PDF/DOCX/HWP/HWPX/PPTX) 모두 이미지 추출 가능.
v0.5 진입의 모든 자산이 박혔으므로 다음 patch 후보 없음.)
