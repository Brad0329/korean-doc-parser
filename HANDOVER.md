...
> **현재 상태 (2026-05-22):** **v0.2.0 출시 완료** — PDF / DOCX / HWP / HWPX 4포맷.
...
>
> **새 세션 시작 시 우선순위:**
> 1. CLAUDE.md (코딩 규칙) + 본 문서의 § 1 (배경) + § 4 (1차 작업 교훈) 정독
> 2. 가장 최신 worklog (현재: `worklog/007_v0.2.0_release.md`) 의 § 5 "다음 세션이 알아야 할 것"
> 3. (선택) 본 문서의 § 2 (확정 설계) ~ § 7 (명명/포지셔닝) 으로 전체 맥락 보강
>
