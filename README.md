...
**상태:** **v0.2.0 출시** (2026-05-22). PDF / DOCX / HWP / HWPX 4포맷 지원.
PPTX / PPT / DOC 는 v0.3 으로 이월 — `worklog/007_v0.2.0_release.md` 참고.
...
- **현재 v0.2.0:** PDF / DOCX / **HWP** / **HWPX** (4포맷)
- **v0.3 예정:** PPTX / PPT / DOC (3포맷 추가 → 합계 7포맷)
...
| **DOC** | LibreOffice → DOCX 변환 후 자체 파서 | `packages/core` | v0.3 |
| **PPTX** | markitdown 위임 (text 23K vs 자체 170) | `packages/core` | v0.3 |
| **PPT** | LibreOffice → PPTX 변환 후 markitdown | `packages/core` | v0.3 |
